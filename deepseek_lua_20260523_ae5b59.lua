...
-- // ========== CONTOH PENGGUNAAN ========== //
-- Jalankan semua contoh di bawah ini

local player = game.Players.LocalPlayer
local playerGui = player:WaitForChild("PlayerGui")

-- Contoh 1: Icon Home di kiri
local homeIcon = TopbarPlus.new()
homeIcon:setImage("rbxassetid://6031094839")
homeIcon:setLabel("Home")
homeIcon:setLeft()
homeIcon.widget.Parent = playerGui
homeIcon:bindEvent("selected", function(icon)
    print("Home diklik!")
end)

-- Contoh 2: Icon Settings di kanan
local settingsIcon = TopbarPlus.new()
settingsIcon:setImage("rbxassetid://6031094839")
settingsIcon:setLabel("Settings")
settingsIcon:setRight()
settingsIcon.widget.Parent = playerGui
settingsIcon:bindEvent("selected", function(icon)
    print("Settings diklik!")
end)

-- Contoh 3: Icon dengan custom theme
local customIcon = TopbarPlus.new()
customIcon:setImage("rbxassetid://6031094839")
customIcon:setLabel("Custom")
customIcon:setMid()
customIcon:modifyTheme({ "IconButton", "BackgroundColor3", Color3.fromRGB(255, 100, 100) })
customIcon:modifyTheme({ "IconButton", "BackgroundTransparency", 0.3 })
customIcon.widget.Parent = playerGui
customIcon:bindEvent("selected", function()
    print("Custom icon diklik!")
end)

print("TopbarPlus berhasil dimuat! Total icon: " .. #TopbarPlus.getIcons())